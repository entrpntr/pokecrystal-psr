roms := pokecrystal.gbc pokecrystal11.gbc pokecrystal_au.gbc
...
tidy:
	rm -f $(roms) $(pokecrystal_obj) $(pokecrystal11_obj) $(pokecrystal_au_obj) $(roms:.gbc=.map) $(roms:.gbc=.sym) rgbdscheck.o
	$(MAKE) clean -C tools/
